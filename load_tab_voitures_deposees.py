...
def load_tab_voitures_deposees():
	save_txt = open('save_tab_voitures_deposees', 'r') #lecture du fichier sauvegarder
	...
	for i in range(len(save_str)):
		...
		#sinon, valide en mettant ds le tableau
			...
			tab_voitures_deposees.append(int(current_str))
			i += 1
			current_str = ""	
